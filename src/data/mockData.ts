import { Discipline, Theme, Compendium, Question, ClinicalCase, Flashcard } from '../types';
...
export const INITIAL_CLINICAL_CASES: ClinicalCase[] = [
  {
    ...
    themeId: 'cardio-ic',
    compendiumRefId: 'comp-cardio-ic',
    title: 'Caso Clínico: Dispneia Progressiva e Fadiga no Paciente Pós-Infarto',
    patientAge: 58,
    patientGender: 'M',
    chiefComplaint: '"Doutor, sinto falta de ar quando me deito e minhas pernas estão inchando há 3 semanas."',
    difficulty: 'medio',
    estimatedMinutes: 8,
    summary: 'Investigação e tomada de decisão no manejo da descompensação de insuficiência cardíaca crônica com fração de ejeção reduzida em ambiente ambulatorial especializado.',
    steps: [
      {
        id: 'step-1',
        stage: 'anamnese',
        stageTitle: 'Etapa 1: Anamnese e História da Doença Atual',
        clinicalData: `Paciente masculino, 58 anos, ex-tabagista e hipertenso. Teve infarto agudo do miocárdio com colocação de stent farmacológico na artéria coronária descendente anterior há 1 ano.
Refere cansaço e falta de ar que iniciaram há 1 mês aos grandes esforços e agora ocorrem ao tomar banho ou caminhar menos de 100 metros no plano (NYHA III).
Relata que há 10 dias precisa dormir com 3 travesseiros para não acordar sufocado no meio da noite (ortopneia e dispneia paroxística noturna). Nega febre, dor torácica aguda ou tosse purulenta.
Medicamentos em uso: Carvedilol 6,25 mg 2x/dia, Enalapril 10 mg 2x/dia, AAS 100 mg/dia e Atorvastatina 40 mg/dia.`,
        question: {
          prompt: 'Qual dos seguintes sintomas relatados pelo paciente apresenta MAIOR especificidade para o diagnóstico de insuficiência cardíaca esquerda?',
          options: [
            {
              id: 'opt-1',
              text: 'Fadiga ao final da tarde e cansaço aos médios esforços.',
              isBestChoice: false,
              score: 0,
              clinicalFeedback: 'Fadiga e cansaço são sintomas sensíveis, mas altamente inespecíficos, podendo decorrer de anemia, sedentarismo ou hipotireoidismo.',
            },
            {
              id: 'opt-2',
              text: 'Dispneia paroxística noturna e ortopneia com necessidade de múltiplos travesseiros.',
              isBestChoice: true,
              score: 100,
              clinicalFeedback: 'Excelente! A dispneia paroxística noturna e ortopneia decorrem do aumento do retorno venoso na posição supina, sobrecarregando o ventrículo esquerdo doente e elevando a pressão capilar pulmonar de forma aguda. Possuem especificidade superior a 90% para IC.',
            },
            {
              id: 'opt-3',
              text: 'Cefaleia matinal e palpitações esporádicas.',
              isBestChoice: false,
              score: 0,
              clinicalFeedback: 'Não têm correlação direta com congestão pulmonar ou disfunção ventricular.',
            },
          ],
        },
      },
      {
        id: 'step-2',
        stage: 'exame_fisico',
        stageTitle: 'Etapa 2: Exame Físico Cardiovascular e Pulmonar',
        clinicalData: `Paciente lúcido, orientado, eupneico em repouso sentado, porém com desconforto respiratório imediato ao assumir o decúbito dorsal.
Sinais vitais: PA 130/80 mmHg, FC 82 bpm rítmica, FR 20 irpm, SpO2 94% em ar ambiente.
Aparelho Cardiovascular: Ictus cordis desviado para o 6º espaço intercostal na linha axilar anterior (cardiomegalia), com presença audível de 3ª bulha cardíaca (B3 em galope).
Turgência jugular patológica presente a 45 graus com refluxo hepatojugular positivo.
Aparelho Respiratório: Murmúrio vesicular presente com estertores crepitantes tele-expiratórios em terço inferior bilateral de ambos os campos pulmonares.
Membros inferiores: Edema simétrico, depressível (cacifo +2/4+) até a altura do joelho.`,
        vitalsAndLabs: {
          'Pressão Arterial': '130/80 mmHg',
          'Frequência Cardíaca': '82 bpm',
          'Ausculta Cardíaca': 'B3 presente (som de galope)',
          'Estase Jugular': 'Presente a 45°',
          'Estertores': 'Crepitantes bibasais',
          'Edema MMII': 'Cacifo 2+/4+',
        },
        question: {
          prompt: 'Com base no exame físico, como você classifica o perfil hemodinâmico de Stevenson deste paciente?',
          options: [
            {
              id: 'opt-2a',
              text: 'Perfil A (Quente e Seco) - sem congestão e sem má perfusão.',
              isBestChoice: false,
              score: 0,
              clinicalFeedback: 'Incorreto. O paciente apresenta sinais francos de sobrecarga volumétrica (B3, turgência jugular, estertores, edema).',
            },
            {
              id: 'opt-2b',
              text: 'Perfil B (Quente e Úmido) - bem perfundido e intensamente congesto.',
              isBestChoice: true,
              score: 100,
              clinicalFeedback: 'Correto! O paciente está bem perfundido (PA adequada, extremidades quentes, sem rebaixamento) e francamente congesto (pulmões com estertores, B3, turgência jugular e edema). É o padrão mais comum de descompensação ambulatorial.',
            },
            {
              id: 'opt-2c',
              text: 'Perfil L (Frio e Seco) - hipoperfundido sem congestão.',
              isBestChoice: false,
              score: 0,
              clinicalFeedback: 'Incorreto. O paciente não está chocado e apresenta nítida retenção hídrica.',
            },
          ],
        },
      },
      {
        id: 'step-3',
        stage: 'conduta',
        stageTitle: 'Etapa 3: Planejamento Terapêutico e Otimização',
        clinicalData: `Exames complementares:
- Ecocardiograma: FEVE 28% com acinesia anterior e septal, diâmetro diastólico do VE 66 mm (remodelamento excêntrico).
- Laboratório: Creatinina 1,1 mg/dL, Potássio 4,3 mEq/L, Sódio 138 mEq/L, NT-proBNP 2.450 pg/mL.
- ECG: Ritmo sinusal, onda Q patológica em V1-V4, sem bloqueio de ramo esquerdo (QRS 95 ms).`,
        question: {
          prompt: 'Qual é o plano farmacológico imediato e a longo prazo mais apropriado para desobstrução congestiva e reversão do remodelamento adverso?',
          options: [
            {
              id: 'opt-3a',
              text: 'Prescrever Furosemida 40 mg/dia para descongestão rápida e associar Espironolactona 25 mg/dia + Dapagliflozina 10 mg/dia, planejando titular o Carvedilol e transicionar Enalapril para Sacubitril/Valsartana.',
              isBestChoice: true,
              score: 100,
              clinicalFeedback: 'Perfeito! A Furosemida trará alívio sintomático rápido da congestão pulmonar e periférica, enquanto a Espironolactona e a Dapagliflozina completam os 4 pilares neuro-humorais que diminuem mortalidade e hospitalização.',
            },
            {
              id: 'opt-3b',
              text: 'Suspender o betabloqueador imediatamente, prescrever Amiodarona e solicitar implante de marcapasso biventricular.',
              isBestChoice: false,
              score: 0,
              clinicalFeedback: 'Incorreto. A terapia de ressincronização cardíaca (TRC) exige QRS alargado (≥ 130-150 ms com BRE) e o QRS do paciente é estreito (95 ms). Além disso, não há indicação de suspender o betabloqueador se o paciente não está chocado.',
            },
            {
              id: 'opt-3c',
              text: 'Apenas prescrever repouso no leito e dieta hipossódica estrita sem alterações nos medicamentos.',
              isBestChoice: false,
              score: 0,
              clinicalFeedback: 'Incorreto. A ausência de tratamento farmacológico das diretrizes aumenta gravemente o risco de morte súbita e reinternação.',
            },
          ],
        },
      },
    ],
    finalDiscussion: `Este caso ilustra a apresentação clássica de Insuficiência Cardíaca com Fração de Ejeção Reduzida (ICFEr) pós-infarto com perfil clínico B (Quente e Úmido). O manejo envolve duas frentes essenciais: (1) Sintomática com diurético de alça (Furosemida) para drenagem da congestão tecidual; e (2) Prognóstica com a quádrupla terapia (ARNI/iECA + BB + ARM + iSGLT2) que reduz a mortalidade e evita o remodelamento patológico.`,
    clinicalTakeaways: [
      'B3 é o achado semiológico patognomônico de enchimento ventricular rápido sob alta pressão em ventrículo dilatado e complacência reduzida.',
      'Sintomas de congestão (B) pedem diurético de alça para alívio imediato, mas diuréticos não substituem a terapia modificadora de prognóstico.',
      'A quádrupla terapia neuro-humoral deve ser implementada antes da alta ou nas primeiras semanas de acompanhamento.',
    ],
  },
];
