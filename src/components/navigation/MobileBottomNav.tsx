...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav
      ...
      className="fixed bottom-3 left-1/2 -translate-x-1/2 z-40 w-[94%] max-w-md md:hidden bg-white/95 dark:bg-[#0F172A]/95 backdrop-blur-xl border border-slate-200/90 dark:border-[#243452] elev-xl shadow-slate-900/10 dark:shadow-black/50 rounded-2xl p-1.5 flex items-center justify-around transition-all animate-in fade-in slide-in-from-bottom-2"
    >
      {navItems.map((item) => {
