...
export const QuestionsView: React.FC<QuestionsViewProps> = ({
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto space-y-6">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-slate-950 via-teal-950 to-cyan-950 rounded-3xl p-6 sm:p-8 text-white shadow-md border border-teal-900/40 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-5 py-3 rounded-2xl bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-slate-950 font-extrabold text-xs shadow-lg shadow-teal-500/20 transition-all flex items-center gap-2 shrink-0 cursor-pointer"
        >
      ...
      {/* Multi-Filter Bar */}
      <div className="bg-white dark:bg-[#0F172A] rounded-3xl border border-slate-200 dark:border-[#243452] p-5 shadow-xs space-y-4">
