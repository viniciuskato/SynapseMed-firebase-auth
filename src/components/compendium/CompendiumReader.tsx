          ...
          <footer className="pt-8 border-t border-[#E2E8F0] dark:border-[#263244] mt-12">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
              <div>
                ...
                <p className="text-xs text-[#64748B] dark:text-[#94A3B8]">
                  Texto da referência preservado como cadastrado. Quando existe um link (curado, DOI ou PMID), ele fica disponível para consulta; sem identificador confiável, mostramos uma sugestão de busca, nunca uma afirmação de acesso.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              {compendium.references.map((ref, rIdx) => {
                ...
                const citation = formatCitationForDisplay(ref, linkInfo?.url);
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                      <div className="flex items-start gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0 flex-1 space-y-1">
                          <p className="text-xs text-[#1E293B] dark:text-[#E2E8F0] leading-relaxed break-words">
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-start shrink-0">
                        <button
                          type="button"
                          onClick={(e) => handleCopyAbnt(e, citation.citationText, rIdx)}
                          ...
                          title="Copiar texto da referência como cadastrado"
                        >
                          {copiedRefIdx === rIdx ? (
                            <>
